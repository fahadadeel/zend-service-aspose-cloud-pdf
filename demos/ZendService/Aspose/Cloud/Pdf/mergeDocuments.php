...
$document->setFileName('Aspose_Merge.pdf');

$sourceFiles = array('test_file.pdf','test_file_on_storage.pdf','test_replace_text.pdf');

var_dump($document->mergeDocuments($sourceFiles));